export default {
  ...
  keys: {
    ...
    addHeader: "添加请求头",
    // JSON规则相关
    inboundRules: "入站规则（请求体转换）",
    inboundRulesTooltip: "在请求转发至上游前，对请求体JSON进行修改。支持添加、修改、删除字段操作",
    ...
    actionAdd: "添加",
    actionRemove: "删除",
    willRemoveField: "将删除此字段",
    addInboundRule: "添加入站规则",
    addOutboundRule: "添加出站规则",
    ...
    targetModel: "目标模型",
    addTarget: "添加目标",
    addSourceModel: "添加源模型",
    atLeastOneTarget: "至少需要一个目标模型",
    never: "从未",
    daysAgo: "{days}天前",
    hoursAgo: "{hours}小时前",
